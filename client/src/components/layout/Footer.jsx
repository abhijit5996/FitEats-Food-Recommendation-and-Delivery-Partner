  ...
  return (
    <footer className="bg-[#1a1a2e] text-white mt-auto relative overflow-hidden border-t border-[#2c2c54]">
      <div className="container-custom py-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-[#6c757d] text-sm">support@fiteats.com</span>
                </li>
              </ul>
              <ul className="space-y-3">
                <li className="flex items-start">
                ...
                <li className="flex items-center mt-6">
                  <div className="flex space-x-4">
                    <a href="#" className="text-[#6c757d] hover:text-[#ffc107] transition-colors duration-300">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#2c2c54] mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#6c757d] text-sm order-2 md:order-1 mt-4 md:mt-0">
            &copy; {currentYear} FitEats. All rights reserved.
          </p>
          ...
          <div className="flex items-center space-x-4 order-1 md:order-2">
            ...
            <button 
              onClick={scrollToTop}
              className="text-[#6c757d] hover:text-[#ffc107] transition-all duration-300 p-2 bg-[#2c2c54] rounded-lg"
